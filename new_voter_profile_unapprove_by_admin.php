			...
			<div class="col-md-6">
				...
				<div class="col-md-6">
					...
					<div style="background:#CCCCCC; padding:20px;">					
						...
						<h3 style="font-size:20px;color:#333333; text-align:center;">Confirm Voter <input style="height:auto; width:30px;" id="checkbox" type="checkbox" name="public_approve" value="Deactivate" required /></h3>
