			...
			<div class="col-md-6">
				...
				<div class="col-md-8">
					...
					<div style="background:#CCCCCC; padding:20px;">					
						...
						<h3 style="font-size:20px;color:#333333; text-align:center;">Confirm Candidate <input style="height:auto; width:30px;" id="checkbox" type="checkbox" name="can_approve" value="Activate" required /></h3>
