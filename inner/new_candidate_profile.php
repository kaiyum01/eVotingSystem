         ...
         <div class="container">
            	...
            	<div class="row">
                	...
                	<div class="row">
                    	...
                    	<div class="col-md-6">
                    	 <a href="new_candidate_profile_update.php" class="btn btn-success" style="float:right;margin-top:12px;margin-bottom:5px;margin-right:48px;" role="button">Update</a>
    ...
    ?>
                      ...
                      <label><div class="heading_block">User Name:</div></label>
                       ...
                       <label><div class="heading_block">Contact:</div></label>
                                  <div class="block"><?php echo $data[8];?></div>
                       ...
                       <label><div class="heading_block">Reference 1:</div></label>
                                  <div class="block"><?php echo $data[4];?></div>
