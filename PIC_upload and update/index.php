...
<tr>
<td>User Name</td>
<td><input type="text" name="user_name"  placeholder="User Name" id="user_name" ></td>
</tr>
<tr>
...
<tr>
<td><input type="submit" name="commit" value="Upload" class="submit"></td>
</tr>
<tr>
...
<?
	...
	$expensions 	= array("jpeg","jpg","png");
		...
		if(empty($errors)==true){
		  ...
		  $sql=mysql_query("insert into   up(user_name,pic_link)values('$user_name','$custom_image_name')");
