...
$total = $row[0];
	...
	echo '<div class="alert alert-success">'."<strong>"."public_is_vote_status: ! Ttotal public_is_vote_status casting "."</strong>".'<a class="btn-info" style="margin-left:10px;padding:10px;font-weight:normal;font-size:50px;" href="#">'.$total."</a>"."</div>";
?>
