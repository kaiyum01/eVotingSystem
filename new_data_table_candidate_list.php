...
<td>Profile</td>
    ...
    $sql="Select * from candidate_reg where can_approve='deactivate'";
    ...
    <tr>
        ...
        <td><?php echo '<a class="btn btn-info" href="new_candidate_profile_approve_by_admin.php?sid='.$data[3].'"  target="_blank">Click to Activate</a>';?></td>
    </tr>
