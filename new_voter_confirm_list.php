...
?>
    ...
    <h4 style="text-align:center;padding-top:5px;padding-bottom:5px;background-color:#F1F1F1;color:#D9534F">Confirm Voter List</h4>               		 
	<?php
	include("new_data_table_voter_confirm_list.php");
	?>	
</div>
