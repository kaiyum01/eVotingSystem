...
?><option value="<?php echo $keyvalue; ?>" <?php if( $keyvalue==$data['voter_reg_last_date_status']) { echo "selected";} else{ echo 'Hide';} ?> ><?php echo $txtvalue; ?>
</option>	
<?php
}
?>
...
?>
    ...
    <h4 style="text-align:center;padding-top:5px;padding-bottom:5px;background-color:#F1F1F1;color:#D9534F">Confirm Candidate List</h4>               		 
<?php
include("new_data_table_candidate_confirm_list.php");
?>	
</div>
