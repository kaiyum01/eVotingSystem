...
$sql="Update  candidate_reg set can_fullname='$can_fullname',admin_voter_id='$admin_voter_id',can_refer_id_one='$can_refer_id_one' where can_fullname='$can_fullname'";
...
$id=$_GET['sid'];
$sqla="Select * from candidate_reg where can_fullname=$id";
...
<form action="" method="post" class="form-horizontal">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="can_fullname" class="form-control"  placeholder="can_fullname" required value="<?php echo $data[1]?>"
>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="admin_voter_id" class="form-control"  placeholder="admin_voter_id" required value="<?php echo $data[2]?>"
>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="can_refer_id_one" class="form-control"  placeholder="can_refer_id_one" required value="<?php echo $data[3]?>"
>
    </div>
  </div>               
